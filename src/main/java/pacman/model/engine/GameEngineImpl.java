...
public class GameEngineImpl implements GameEngine {
    ...
    private RenderableFactoryRegistry getRenderableFactoryRegistry() {
        ...
        renderableFactoryRegistry.registerFactory(RenderableType.GHOST_BLINKY, new GhostFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.GHOST_PINKY, new GhostFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.GHOST_INKY, new GhostFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.GHOST_CLYDE, new GhostFactory());
